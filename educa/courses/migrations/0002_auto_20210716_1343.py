# Generated by Django 3.2.5 on 2021-07-16 13:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.ForeignKey(limit_choices_to={'model__in': ('text', 'video', 'image', 'file')}, on_delete=django.db.models.deletion.CASCADE, related_name='content', to='courses.module')),
            ],
        ),
    ]
